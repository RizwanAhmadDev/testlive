                    ...
                    <div class="card-body p-4">
                        <div class="row justify-space-between">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="{{ route('addTaxi') }}" class="btn btn-primary">Add Taxi</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($taxi as $item)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0"><img width="100px" height="100px" src="{{ asset('/assets/uploads/taxiimages/'.$item->taxi_picture) }}"></td>
                                            
                                            <td class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0 fs-4">
                                                    <a href="{{ url('editTaxi/'.$item->id) }}"><i class="ti ti-pencil"></i></a>
                                                    <a href="{{ url('deleteTaxi/'.$item->id) }}"><i class="ti ti-trash"></i></a>
                                                </h6>
                                            </td>
                                        </tr>
                                        {{--  <tr>
