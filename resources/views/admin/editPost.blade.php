                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="feature_image" id="featureImage" value="{{ asset('/assets/uploads/postimages/'.$Post->feature_image) }}" class="form-control" accept=".png,.jpg">
                                        <img src="{{ asset('/assets/uploads/postimages/'.$Post->feature_image) }}" width="100px" height="100px" alt="">
                                    </div>
                                    <div class="mb-3">
